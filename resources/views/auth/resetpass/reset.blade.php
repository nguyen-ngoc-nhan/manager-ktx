...
<body class="animsition">
                    ...
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            <form action="" method="post">
                                ...
                                <button class="au-btn au-btn--block au-btn--green m-b-20" type="submit">Gửi lại mật khẩu</button>
                            </form>
                            <div class="register-link">
                                <p>
                                    Bạn chưa có tài khoảng?
                                    <a href="{{route('auth.register')}}">Đăng ký tài khoảng tại đây</a>
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Vendor JS       -->
    <script src="{{$adminUrl}}/vendor/slick/slick.min.js">
    </script>
